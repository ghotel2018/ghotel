...
var CouponMnt = {
		...
		searchUrl: "authorized/couponKorea/getAll" , //如果searchTableRequired 是 true 必填
		getUrl: "authorized/couponKorea/get/" ,
		batchUpdateUrl: "authorized/couponKorea/batchUpdate" ,
		exportUrl: "authorized/couponKorea/export" ,
		getConfigUrl : "authorized/couponKorea/getConfig" ,
		initNotSearch:true,
		columns : [ [ {
			field : 'groupId',
			title : '所属批次号',
		...
		{field: 'usefulStartDate', title:'使用有效期' , width: '20%' , align: 'center',
			...
			formatter:function(value,row,index){
			   var discountType="";
			   if(row.couponType==9||row.couponType=='9'){
