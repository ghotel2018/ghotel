...
var CouponMnt = {
		...
		searchUrl: "authorized/coupon/getAll" , //如果searchTableRequired 是 true 必填
		getUrl: "authorized/coupon/get/" ,
		batchUpdateUrl: "authorized/coupon/batchUpdate" ,
		exportUrl: "authorized/coupon/export" ,
		getConfigUrl : "authorized/coupon/getConfig" ,
		initNotSearch:true,
		columns : [ [{
			field : 'groupId',
			title : '所属批次号',
...
/*	$('#batchUpdate_file').bind('change',function(){
	...
	$("#couponSearch").click(function(){
		...
		console.log(bindID);
		console.log(bindMember);
		console.log(discountCode);
		console.log(groupIdcx);
