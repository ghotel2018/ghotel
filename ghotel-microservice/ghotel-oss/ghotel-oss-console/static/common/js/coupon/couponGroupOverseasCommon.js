...
var CouponGroupCommon = {
    ...
    getConfigUrlOverseas:"authorized/couponGroupOverseas/pageConfig" ,
    addOverseas: "authorized/couponGroupOverseas/addOverseas" ,
...
//	    readonly:true,
    ...
    $("#updateBtn_update").click(function(){
        ...
        if(checkData('update','#updateCouponGroupForm')){//如果是运价优惠卷,则不要使用checkAccount()
            ...
            CouponGroupCommon.submitUpdateRequest(data,CouponGroupCommon.updateOverseasUrl,'update');
        }
    });
    ...
    CouponGroupCommon.intConfig = function(initChannel,initGateWay, initAccount){
        var configUrl=CouponGroupCommon.getConfigUrlOverseas+"?channel="+$('#channel').val();
        CMC.request({
            url: configUrl ,
            method: 'GET',
            async: false,
...
function statusmanage(formId,str,ind){
    ...
    var url =  CouponGroupCommon.updateOverseasUrl;
    if(ind =='update_I18n'){
...
function addOverseas() {
    if(checkData('create','#createCouponGroupForm')){//如果是运价优惠卷,则不要使用checkAccount()
        ...
        CouponGroupCommon.submitAddRequest(data,CouponGroupCommon.addOverseas,'#createCouponGroupForm','create');
