...
var CouponMnt = {
		menuId : 'CouponOverseas',
		searchTableRequired : true,
		searchTableWidth: '100%',
		searchUrl: "authorized/couponOverseas/getAll" , //如果searchTableRequired 是 true 必填
		getUrl: "authorized/couponOverseas/get/" ,
		batchUpdateUrl: "authorized/couponOverseas/batchUpdate" ,
		exportUrl: "authorized/couponOverseas/export" ,
		getConfigUrl : "authorized/couponOverseas/getConfig" ,
		initNotSearch:true,
		columns : [ [ {
			field : 'groupId',
			title : '所属批次号',
		...
		{field: 'usefulStartDate', title:'使用有效期' , width: '20%' , align: 'center',
			...
			formatter:function(value,row,index){
			   var discountType="";
			   if(row.couponType==17||row.couponType=='17'){
