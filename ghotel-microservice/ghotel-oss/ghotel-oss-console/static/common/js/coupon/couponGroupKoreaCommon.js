...
//	    readonly:true,
    ...
    $("#updateBtn_update").click(function(){
        ...
        if(checkData('update','#updateCouponGroupForm')){//如果是运价优惠卷,则不要使用checkAccount()
            ...
            CouponGroupCommon.submitUpdateRequest(data,CouponGroupCommon.updateKoreaUrl,'update');
        }
    });
    ...
    CouponGroupCommon.intConfig = function(initChannel,initGateWay, initAccount){
        ...
        var configUrl=CouponGroupCommon.getConfigUrlKorea;
        CMC.request({
            url: configUrl ,
            method: 'GET',
            async: false,
...
function statusmanage(formId,str,ind){
    ...
    var url =  CouponGroupCommon.updateKoreaUrl;
    if(ind =='update_I18n'){
