...
var CmcCoupAccountPayment = {
	menuId: "CmcCoupAccountPaymentAUS",
    searchUrl : '/authorized/coupAccountPaymentAUS/getAUSAll',
    getAUSAccount : '/authorized/coupAccountPaymentAUS/getAUSAccount',
    addUrl : '/authorized/coupAccountPaymentAUS/addAUSAccount',
    exportedData:null,
...
CmcCoupAccountPayment.queryAccount = function(formid){
	CMC.request({
		url: CmcCoupAccountPayment.getAUSAccount,
		method: "get",
		dataType: "json",
		async: true,
...
CmcCoupAccountPayment.add=function(){
	$("#coupAccountPaymentAUSCreatFrom").dialog({
	    collapsible: true,
	    title: "虚拟帐号充值",
	    minimizable: false, 
	    maximizable: false,
	    ...
	    width: 400,
	    height: 350,
	    href:"/cmc/module/coupon/virtualAccountAUS.html",
	    onLoad: function () {
	    ...
	    buttons:[{ 
			...
			handler:function(){ 
				...
				if(ok){
					...
					CMC.dialog('coupAccountPaymentAUSCreatFrom','close');
					CMC.request({
