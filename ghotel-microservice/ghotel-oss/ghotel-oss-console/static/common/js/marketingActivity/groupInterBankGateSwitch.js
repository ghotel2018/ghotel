...
function getGroupInterBankGateSwitchOpen(){
		CMC.request({
			method: "POST",
			url: "authorized/groupInterBankGateSwitch/status",
	...
	$('#open').click(function(){
		...
		CMC.confirm("确定开启?", function(r){
			if(r){
				CMC.request({
					method: "POST",
					url: "authorized/groupInterBankGateSwitch/operator",
					data: {
						'flag':flag
					},
				  	success: function(message){
...
$(document).ready(function(){
	getGroupInterBankGateSwitchOpen();
});
